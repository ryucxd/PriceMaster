...
namespace PriceMaster
{
    public partial class frmSlimlineOutstandingChase : Form
    {
        ...
        private void load_data()
        {
            ...
            string sql = "SELECT a.id,a.quote_id,chase_date,chase_description,next_chase_date,u.forename + ' ' + u.surname as chased_by,rtrim(s.[NAME]) as [customer] ,e.sender_email_address,priority_chase " +

...
{
    public partial class frmSlimlineChaseUpdate : Form
    {
        public int validation { get; set; }
        public int quote_id { get; set; }
        public frmSlimlineChaseUpdate(int _quote_id)
        {
            InitializeComponent();
            validation = 0;
            quote_id = _quote_id;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string sql = "UPDATE [order_database].dbo.quotation_feed_back_slimline SET status = '" + cmbStatus.Text + "',too_expensive = " + expensive + ",lead_time_too_long = " + lead + ",quote_took_too_long = " + quote + ",unable_to_meet_spec = " + unable + ",non_responsive_customer = " + non_responsive + " WHERE quote_id = " + quote_id.ToString();

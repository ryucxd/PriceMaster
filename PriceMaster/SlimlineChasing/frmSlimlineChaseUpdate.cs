...
namespace PriceMaster
{
    public partial class frmSlimlineChaseUpdate : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string sql = "UPDATE [order_database].dbo.quotation_feed_back_slimline SET status = '" + cmbStatus.Text + "',too_expensive = " + expensive + ",lead_time_too_long = " + lead + ",quote_took_too_long = " + quote + ",unable_to_meet_spec = " + unable + " " +

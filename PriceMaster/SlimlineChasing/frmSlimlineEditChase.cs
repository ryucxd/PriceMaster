...
{
    public partial class frmSlimlineEditChase : Form
    {
        public int chase_id { get; set; }
        public int MyProperty { get; set; }
        public frmSlimlineEditChase(int _chase_id,DateTime _next_chase)
        {
            InitializeComponent();
            chase_id = _chase_id;
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            string sql = "UPDATE [order_database].dbo.quotation_chase_log_slimline SET next_chase_date = '" + dteNextChase.Value.ToString("yyyyMMdd") + "' where id =  " + chase_id.ToString();
